        ...
        <section class="hero" id="home">
            <div class="container hero-content">
                <div class="hero-text fade-in-left">
                    ...
                    <p>Web Developer Intern and web development student at Passerelles Numériques Cambodia. I build responsive web applications with HTML, CSS, JavaScript, TypeScript, PHP, Laravel, Node.js, Vue.js, Python(Algorithms) and MySQL.</p>
